...
# 1. Setup BASE connection (No database specified here)
server = r'.\SQLEXPRESS'
...
# We add DATABASE=master just for this step
...
# FIXED: Removed the extra single quotes around ingestion inside the EXEC command
cursor.execute("""
...
print("\nWorkflow Complete! Everything is set up.")
...
print("Dirty data ingested successfully into NVARCHAR columns.")
